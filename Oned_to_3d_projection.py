...
def main():
    our_surf = 'C:\\Users\\bygan\\Documents\\Research_at_Cal\\Shadden_lab_w_Numi\\2023_fall\\Pipeline_testing_result\\pipeline_till_simulation_testing\\final_assembly_original_0176_0000_3d_fullres_0_393__surface\\export_ROM_ready_surface.vtp'
    #meshed_surf, meshed_vol = svmeshtool.mesh_polydata(our_surf,'C:\\Users\\bygan\\Documents\\Research_at_Cal\\Shadden_lab_w_Numi\\2023_fall\\Pipeline_testing_result\\pipeline_till_simulation_testing\\final_assembly_original_0176_0000_3d_fullres_0_393__surface\\exported_mesh_vol.vtu')
    ...
    f_vol = 'C:\\Users\\bygan\\Documents\\Research_at_Cal\\Shadden_lab_w_Numi\\2023_fall\\sv_projects\\0176_0000\\Meshes\\0176_0000.vtu'
    f_1d = os.path.join(result_folder, '0176_0000_OUR_GUI_ID_mapped.vtp')
    f_out = os.path.join(result_folder, '0176_0000_OUR_GUI_ID_mapped_3D_proj.vtu')
    f_pkl = os.path.splitext(f_out[0] + '.pkl')
    args = type('', (), {})()
    args.centerline = f_1d
    args.mesh = f_vol
    args.out = f_out
    args.v = 0
    # if os.path.exists(f_pkl):
