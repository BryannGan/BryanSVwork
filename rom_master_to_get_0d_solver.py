...
def setup_ROM_parameters(path,model_name,order):
    if order == 1:
        ...
        Params.mesh_output_file = '1d_model.vtp'
        # create own .dat file? 
...
def set_path_name():
    ...
    result_master_folder = 'C:\\Users\\bygan\\Documents\\Research_at_Cal\\Shadden_lab_w_Numi\\2023_fall\\Pipeline_testing_result\\Pipeline_correct_bc\\0d'
...
# write_to_file('C:\\Users\\bygan\\Documents\\Research_at_Cal\\Shadden_lab_w_Numi\\2023_summer_research\\ROM results\\inflow_files\\rcrt_from_parsing.dat',lines)
        ...
        Cl = Centerlines()
        try:
            Cl.extract_center_lines(zerod_Params)
        except:
